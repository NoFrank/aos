...
var handleScroll = function handleScroll(top, $elements) {
...
var initializeScroll = function initializeScroll() {
  ...
  if (options.targetSelector === 'window') {
    ...
    if (document && document.querySelector(options.targetSelector)) document.querySelector(options.targetSelector).addEventListener('scroll', throttle(function (e) {
 ...
 */
var orientationChangeEvent = debounce(refresh, 50, true);
/*
